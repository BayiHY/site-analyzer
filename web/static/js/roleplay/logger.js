...
function renderLogPanel() {
    ...
    if (_rpLogCollapsed) {
        panel.style.cssText = 'position:fixed;bottom:0;left:0;right:0;background:#111;border-top:1px solid #333;z-index:19;';
    ...
    panel.style.cssText = 'position:fixed;bottom:52px;left:0;right:0;background:#0a0a0a;border-top:1px solid #333;z-index:19;';
